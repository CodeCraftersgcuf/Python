...
def end_program():
    ...
    root.update()
    time.sleep(4)  # Pause for 3 seconds
    root.quit()  # Terminate the program

root = Tk()
root.title("Name Animation")
root.geometry("1366x768")  # Larger size
...
ascii_label = tkinter.Label(root, text=ascii_art1, fg="yellow", bg="black", font=("Courier", 12))
ascii_label.pack(side=tkinter.RIGHT, padx=20, pady=20)

# Create a label for displaying names on the left with padding
name_label = tkinter.Label(root, text="", fg="green", bg="black", font=("Courier", 40))
name_label.pack(side=tkinter.LEFT, padx=40, pady=20)
...
list_of_names_label = tkinter.Label(top_frame, text="List of Students From 2022-23:", fg="blue", bg="black", font=("Courier", 40))
list_of_names_label.pack(pady=30,padx=10)
